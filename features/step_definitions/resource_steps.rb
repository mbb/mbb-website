...
#   "Given a member with login: 'mojojojo'"
# produces a Member instance stored in @member with 'mojojojo' as its login
# attribute.
#
...
#   "And the member has thac0: 3"
# takes the earlier-defined @member instance and sets its thac0 to '3'.
#
...
#
# So, for instance,
#   klass, instance = parse_resource_args 'member'
#   instance = klass.new({login => 'me', password => 'monkey', ...})
#   keep_instance! resource, instance
# keeps the just-constructed Member model in the @member instance variable.
#
