Story: Creating Accounts for Band Members
	As a board member, I want to be able to create accounts for band members so that they are listed on the members page and so that we can track attendance.
	...
	Scenario: You can create an account with all the necessary attributes.
	 Given  a board member logged in as 'Reggie Funkle'
		...
		Then  he should see a notice message 'Oona Funkle has been added to the band!'
		 And  a member with name: 'Oona Funkle' should exist
		 And  the member should have name: 'Oona Funkle', and email: 'unactivated@example.com'
		 And  Reggie Funkle should be logged in
