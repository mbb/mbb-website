...
describe Private::MembersHelper do
  ...
  describe "link_to_member" do
    ...
    it "should use the login as link text with no :content_method specified" do
      link_to_member(@member).should have_tag("a", 'Quentin Daniels')
    end
    it "should use the name as link text with :content_method => :name" do
      link_to_member(@member, :content_method => :name).should have_tag("a", 'Quentin Daniels')
    end
    it "should use the login as title with no :title_method specified" do
      link_to_member(@member).should have_tag("a[title='Quentin Daniels']")
    end
    it "should use the name as link title with :content_method => :name" do
      link_to_member(@member, :title_method => :name).should have_tag("a[title='Quentin Daniels']")
    end
  ...
  describe "link_to_current_member, When logged in" do
    ...
    it "should use the login as link text with no :content_method specified" do
      link_to_current_member().should have_tag("a", 'Quentin Daniels')
    end
    it "should use the name as link text with :content_method => :name" do
      link_to_current_member(:content_method => :name).should have_tag("a", 'Quentin Daniels')
    end
    it "should use the login as title with no :title_method specified" do
      link_to_current_member().should have_tag("a[title='Quentin Daniels']")
    end
    it "should use the name as link title with :content_method => :name" do
      link_to_current_member(:title_method => :name).should have_tag("a[title='Quentin Daniels']")
    end
